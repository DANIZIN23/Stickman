...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		bg2.loadGraphic("assets/images/menu/StartBG.png", false, 1280, 720);
	//	bg2.screenCenter(X);
	...
	//	bg2.scale.set(0.9, 0.9);
		...
		add(bg2);
			...
			logoBl.animation.addByPrefix('bump', 'Logo bumpin stickman', 24);
		...
		gfDance = new FlxSprite(0, 240);
		gfDance.frames = Paths.getSparrowAtlas('menu/Chartitle start');
		gfDance.animation.addByPrefix('idle', 'title start instance 1', 24);
		...
		titleText = new FlxSprite(100, FlxG.height * 0.65);
